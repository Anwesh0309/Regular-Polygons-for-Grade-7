...
import { REFLECT_QUESTIONS } from '../data/content';

const CONFIDENCE_LEVELS = [
  { emoji: '😊', label: "I'm great at regular polygons!", color: '#4caf50' },
...
export default function ReflectPhase({ stats, onRestart, onGoHome }) {
  ...
  if (step === 1) {
    return (
      <div className="reflect-phase">
        <div className="reflect-card">
          <h3 className="reflect-card-title">How do you feel about Regular Polygons?</h3>
  ...
  return (
    <div className="reflect-phase">
      ...
      <div className="certificate-card">
        ...
        <p className="cert-subtitle">You finished all 6 phases!</p>
        ...
        <div className="mascot-container" style={{ marginTop: 16 }}>
          ...
          <div className="speech-bubble">
            {pct >= 80 ? 'Incredible! You are a Regular Polygon Master! 🏆' : pct >= 50 ? 'Great effort! Keep practicing! 💪' : 'Good start! Try again to improve! 📚'}
          </div>
        </div>
